...
\begin{frame}{WiFi}
	\begin{itemize}
		\item Connect to \emph{public-unibe}
...
\begin{frame}
	...
	\end{column}
	\begin{column}{0.5\linewidth}
		\renewcommand{\imsize}{0.8\linewidth}%
		\only<1>{%
		...
		\includegraphics<5>[width=\imsize]{./img/CTAn}%
		\only<6>{%
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \href{https://github.com/habi/Zebra-Fish-Gills/}{The full analysis of the data (\faPython) is also available on GitHub}. Details are found in~\cite{Messerli2019a}: git.io/fjuoF
